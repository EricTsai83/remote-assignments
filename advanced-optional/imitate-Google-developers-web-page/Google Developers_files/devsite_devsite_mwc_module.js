...
_ds.CI(a);return b}});var Y_=function(a){return a.label?(0,_ds.Q)`<span class="devsite-mwc__label ${a.required?"devsite-mwc__label--required":""}">${a.label}</span>`:_ds.Ox},Z_=function(a){return a.icon?(0,_ds.Q)`<span class="devsite-mwc-text-field__icon">
      ...
      <select aria-labelledby="label"
              ...
              ?required="${a.required}"
              ?readonly="${a.readOnly}"
              name="${_ds.sA(""===a.name?void 0:a.name)}"
              @change="${b=>{a.o(b);a.h(b)}}"
              @blur="${a.j}"
              @focus="${a.N}">
      ...
      </span>`},a0=class extends _ds.Cy{static get styles(){return W_}constructor(){super();this.readOnly=!1;this.kind="";this.type="text";this.disabled=this.warning=this.required=this.outlined=!1;this.name=this.value=this.placeholder=this.icon=this.label="";this.invalid=this.focused=!1;this.rows=2;this.cols=20;this.maxLength=this.minLength=-1;this.charCounter=!1;this.staticPath="";this.options=[]}qc(a){super.qc(a);(a=Array.from(this.querySelectorAll("option")).map(b=>({value:b.value,text:b.text,
disabled:b.disabled})))&&a.length&&""!==a[0].text&&""!==a[0].value&&a.unshift({value:"",text:"",disabled:!0});this.options=a;_ds.sy(this)}update(a){a.has("value")&&"string"!==typeof this.value&&(this.value=`${this.value}`);super.update(a)}j(a){this.value=a.target.value.trim();this.focused=!1;""===this.value&&(this.warning=!1)}N(a){this.value=a.target.value.trim();this.focused=!0}o(a){this.value=a.target.value.trim();this.invalid=!1;this.required&&""===this.value?this.invalid=!0:this.value&&(0<this.minLength&&
this.value.length<this.minLength&&(this.invalid=!0),0<this.maxLength&&this.value.length>this.maxLength&&(this.invalid=!0))}h(a){const b=new CustomEvent("change");a&&(this.value=a.target.value.trim());this.dispatchEvent(b)}focus(){const a=new CustomEvent("focus");let b;null==(b=this.yf)||b.dispatchEvent(a);let c;null==(c=this.yf)||c.focus();let d;null==(d=this.gg)||d.dispatchEvent(a);let e;null==(e=this.gg)||e.focus();let f;null==(f=this.Wf)||f.dispatchEvent(a);let g;null==(g=this.Wf)||g.focus()}blur(){const a=
new CustomEvent("blur");let b;null==(b=this.yf)||b.dispatchEvent(a);let c;null==(c=this.yf)||c.blur();let d;null==(d=this.gg)||d.dispatchEvent(a);let e;null==(e=this.gg)||e.blur();let f;null==(f=this.Wf)||f.dispatchEvent(a);let g;null==(g=this.Wf)||g.blur()}select(){let a;null==(a=this.yf)||a.select();let b;null==(b=this.Wf)||b.select()}render(){switch(this.kind){case "textfield":var a=(0,_ds.iK)({"devsite-mwc-text-field--with-leading-icon":this.icon,"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,
"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--warning":this.warning,"devsite-mwc--floating":""!==this.value||this.focused}),b=Y_(this),c=Z_(this);const g=-1===this.minLength?void 0:this.minLength,h=-1===this.maxLength?void 0:this.maxLength;var d=this.type,e=X_(this.value),f=""===this.name?void 0:this.name;return(0,_ds.Q)`
      ...
      <input
          ...
          minlength="${null!=g?g:_ds.Ox}"
          maxlength="${null!=h?h:_ds.Ox}"
          name="${null!=f?f:_ds.Ox}"
          @input="${this.o}"
          @blur="${this.j}"
          @focus="${this.N}"
          @change="${this.h}">`}
    ...
    `;case "select":a:{for(a of this.options)if(a.value.trim()===this.value.trim()){a=a.text.trim();break a}a=""}return(0,_ds.Q)`
        <label class="devsite-mwc-select ${(0,_ds.iK)({"devsite-mwc--disabled":this.disabled,"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":""!==a||this.focused})}">
        ${Y_(this)}
        ${Z_(this)}
        ${$_(this)}
      </label>
    `;case "textarea":return a=(0,_ds.iK)({"devsite-mwc--no-label":!this.label,"devsite-mwc--outlined":this.outlined,"devsite-mwc--disabled":this.disabled,"devsite-mwc--focused":this.focused,"devsite-mwc--invalid":this.invalid,"devsite-mwc--floating":""!==this.value||this.focused}),b=Y_(this),e=-1===this.minLength?void 0:this.minLength,f=-1===this.maxLength?void 0:this.maxLength,c=X_(this.value),d=""===this.name?void 0:this.name,(0,_ds.Q)`
        <label class="devsite-mwc-text-area ${a}">
          ...
          rows="${this.rows}"
          cols="${this.cols}"
          name="${null!=d?d:_ds.Ox}"
          minlength="${null!=e?e:_ds.Ox}"
          maxlength="${null!=f?f:_ds.Ox}"
          @input="${this.o}"
          @blur="${this.j}"
          @focus="${this.N}"
          @change="${this.h}"></textarea>`}
        </label>
        ${!this.charCounter&&this.maxLength?_ds.Ox:(0,_ds.Q)`<span class="devsite-mwc-character-counter">${Math.min(this.value.length,this.maxLength)} / ${this.maxLength}</span>`}
    `;default:return(0,_ds.Q)`<span>Invalid element type</span>`}}};_ds.A([_ds.op("input"),_ds.C(HTMLInputElement)],a0.prototype,"yf",void 0);_ds.A([_ds.op("select"),_ds.C(HTMLSelectElement)],a0.prototype,"gg",void 0);_ds.A([_ds.op("textarea"),_ds.C(HTMLTextAreaElement)],a0.prototype,"Wf",void 0);_ds.A([_ds.M({type:Boolean}),_ds.C(Object)],a0.prototype,"readOnly",void 0);_ds.A([_ds.M({type:String}),_ds.C(Object)],a0.prototype,"kind",void 0);
_ds.A([_ds.M({type:String}),_ds.C(String)],a0.prototype,"type",void 0);_ds.A([_ds.M({type:Boolean}),_ds.C(Object)],a0.prototype,"outlined",void 0);_ds.A([_ds.M({type:Boolean,Ea:!0}),_ds.C(Object)],a0.prototype,"required",void 0);_ds.A([_ds.M({type:Boolean,Ea:!0}),_ds.C(Object)],a0.prototype,"warning",void 0);_ds.A([_ds.M({type:Boolean,Ea:!0}),_ds.C(Object)],a0.prototype,"disabled",void 0);_ds.A([_ds.M({type:String}),_ds.C(Object)],a0.prototype,"label",void 0);
_ds.A([_ds.M({type:String}),_ds.C(Object)],a0.prototype,"icon",void 0);_ds.A([_ds.M({type:String}),_ds.C(Object)],a0.prototype,"placeholder",void 0);_ds.A([_ds.M({type:String}),_ds.C(Object)],a0.prototype,"value",void 0);_ds.A([_ds.M({type:String}),_ds.C(Object)],a0.prototype,"name",void 0);_ds.A([_ds.M({type:Boolean}),_ds.C(Object)],a0.prototype,"focused",void 0);_ds.A([_ds.M({type:Boolean,Ea:!0}),_ds.C(Object)],a0.prototype,"invalid",void 0);
_ds.A([_ds.M({type:Number}),_ds.C(Object)],a0.prototype,"rows",void 0);_ds.A([_ds.M({type:Number}),_ds.C(Object)],a0.prototype,"cols",void 0);_ds.A([_ds.M({type:Number}),_ds.C(Object)],a0.prototype,"minLength",void 0);_ds.A([_ds.M({type:Number}),_ds.C(Object)],a0.prototype,"maxLength",void 0);_ds.A([_ds.M({type:Boolean}),_ds.C(Object)],a0.prototype,"charCounter",void 0);_ds.A([_ds.M({type:String,Ea:!0}),_ds.C(Object)],a0.prototype,"staticPath",void 0);try{window.customElements.define("devsite-mwc",a0)}catch(a){console.warn("Unrecognized DevSite custom element - DevsiteMwc",a)};})(_ds_www);
